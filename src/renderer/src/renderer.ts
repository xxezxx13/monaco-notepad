...
monaco.editor.defineTheme('monaco-notepad-dark', {
  ...
  rules: [
    ...
    { token: 'comment', foreground: '73808E', fontStyle: 'italic' },
    { token: 'keyword', foreground: '7CB7FF' },
    { token: 'keyword.control', foreground: '7CB7FF' },
    { token: 'type', foreground: '6FC2C0' },
    { token: 'type.identifier', foreground: '6FC2C0' },
    { token: 'identifier', foreground: 'E6EDF3' },
    { token: 'string', foreground: 'D6B783' },
    { token: 'string.key.json', foreground: '9CCAF0' },
    { token: 'number', foreground: 'B9A5E3' },
    { token: 'regexp', foreground: 'D28B8B' },
    { token: 'operator', foreground: 'AAB6C3' },
    { token: 'delimiter', foreground: '8F9BA9' },
    { token: 'tag', foreground: '7CB7FF' },
    { token: 'attribute.name', foreground: '9CCAF0' },
    { token: 'attribute.value', foreground: 'D6B783' },
    { token: 'metatag', foreground: '7E8A99' },
    { token: 'variable', foreground: 'E6EDF3' },
    { token: 'constant', foreground: 'B9A5E3' }
  ],
  colors: {
    'editor.background': '#0F141A',
    'editor.foreground': '#E6EDF3',
    'editorCursor.foreground': '#58AEFF',
    'editor.selectionBackground': '#1F5D8F',
    'editor.inactiveSelectionBackground': '#193C59',
    'editor.selectionHighlightBackground': '#1C486A',
    'editor.wordHighlightBackground': '#1C486A66',
    'editor.wordHighlightStrongBackground': '#28608677',
    'editor.findMatchBackground': '#8C6A2A',
    'editor.findMatchHighlightBackground': '#59472188',
    'editor.findRangeHighlightBackground': '#4AA8FF1F',
    'editor.lineHighlightBackground': '#141C24',
    'editorLineNumber.foreground': '#506072',
    'editorLineNumber.activeForeground': '#A6B4C3',
    'editorWhitespace.foreground': '#26323F',
    'editorIndentGuide.background1': '#1C2731',
    'editorIndentGuide.activeBackground1': '#334454',
    'editorWidget.background': '#151C24',
    'editorWidget.foreground': '#E6EDF3',
    'editorWidget.border': '#354252',
    'input.background': '#111820',
    'input.foreground': '#E6EDF3',
    'input.border': '#354252',
    'input.placeholderForeground': '#748191',
    focusBorder: '#4AA8FF',
    'list.activeSelectionBackground': '#174B73',
    'list.activeSelectionForeground': '#FFFFFF',
    'list.hoverBackground': '#1C2732',
    'scrollbar.shadow': '#00000000',
    'scrollbarSlider.background': '#6C7D9055',
    'scrollbarSlider.hoverBackground': '#7F91A66F',
    'scrollbarSlider.activeBackground': '#94A6BA88'
  }
})
...
monaco.editor.defineTheme('monaco-notepad-light', {
  ...
  inherit: true,
  rules: [
    { token: '', foreground: '22272E' },
    { token: 'comment', foreground: '6F7782', fontStyle: 'italic' },
    { token: 'keyword', foreground: '155FA0' },
    { token: 'keyword.control', foreground: '155FA0' },
    { token: 'type', foreground: '2F7C7A' },
    { token: 'type.identifier', foreground: '2F7C7A' },
    { token: 'identifier', foreground: '22272E' },
    { token: 'string', foreground: '9A5B33' },
    { token: 'string.key.json', foreground: '356F9F' },
    { token: 'number', foreground: '7358A2' },
    { token: 'regexp', foreground: 'A24B5B' },
    { token: 'operator', foreground: '56616D' },
    { token: 'delimiter', foreground: '6B7580' },
    { token: 'tag', foreground: '155FA0' },
    { token: 'attribute.name', foreground: '356F9F' },
    { token: 'attribute.value', foreground: '9A5B33' },
    { token: 'metatag', foreground: '7A657D' },
    { token: 'variable', foreground: '22272E' },
    { token: 'constant', foreground: '7358A2' }
  ],
  colors: {
    'editor.background': '#FBFCFD',
    'editor.foreground': '#22272E',
    'editorCursor.foreground': '#1F7ACB',
    'editor.selectionBackground': '#B8DAF5',
    'editor.inactiveSelectionBackground': '#DCE8F2',
    'editor.selectionHighlightBackground': '#DCECF8',
    'editor.wordHighlightBackground': '#DCECF888',
    'editor.wordHighlightStrongBackground': '#BBDCF3AA',
    'editor.findMatchBackground': '#FFE08A',
    'editor.findMatchHighlightBackground': '#FFF1C288',
    'editor.findRangeHighlightBackground': '#1F7ACB14',
    'editor.lineHighlightBackground': '#F2F5F8',
    'editorLineNumber.foreground': '#9AA3AD',
    'editorLineNumber.activeForeground': '#4D5967',
    'editorWhitespace.foreground': '#D9DEE5',
    'editorIndentGuide.background1': '#E7EBEF',
    'editorIndentGuide.activeBackground1': '#C7CFD8',
    'editorWidget.background': '#F7F9FB',
    'editorWidget.foreground': '#22272E',
    'editorWidget.border': '#C9D0D8',
    'input.background': '#FFFFFF',
    'input.foreground': '#22272E',
    'input.border': '#BBC4CE',
    'input.placeholderForeground': '#7A8591',
    focusBorder: '#1F7ACB',
    'list.activeSelectionBackground': '#DCECF8',
    'list.activeSelectionForeground': '#22272E',
    'list.hoverBackground': '#EEF4F9',
    'scrollbar.shadow': '#00000000',
    'scrollbarSlider.background': '#69768533',
    'scrollbarSlider.hoverBackground': '#69768555',
    'scrollbarSlider.activeBackground': '#69768577'
  }
})
